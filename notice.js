/**
 * Prototype Notice & Agency Lead Capture
 * Developed by Quartermasters F.Z.C
 * WhatsApp / Call: +971 52 7529598
 */
(function() {
    ...
    function initNotice() {
        ...
        // 1. Non-destructively reroute any contact/call/WhatsApp links on the page to Quartermasters
        ...
        style.innerHTML = `
            ...
            #qm-notice-modal {
                ...
                max-width: 530px;
                border-radius: 20px;
                box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(226, 232, 240, 0.9);
                overflow: hidden;
                position: relative;
                animation: qmSlideUp 0.35s cubic-bezier(0.16, 1, 0.3, 1);
            }
            ...
            /* Sticky persistent top announcement */
            #qm-sticky-bar {
                position: fixed;
                top: 0;
                left: 0;
            ...
            .qm-sticky-right a:hover {
                text-decoration: underline;
            }
            .qm-sticky-right a.qm-sticky-wa:hover {
                background: #1eb956;
                text-decoration: none;
            }
        `;
        ...
        overlay.innerHTML = `
            <div id="qm-notice-modal" role="dialog" aria-modal="true" aria-labelledby="qm-title">
